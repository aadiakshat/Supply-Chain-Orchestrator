    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <span className="px-3 py-1 text-xs font-semibold bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 rounded-full border border-green-200 dark:border-green-800"> API Data</span>
        </div>
      </div>
        ...
        <div className="glass rounded-2xl p-6 flex flex-col shadow-sm">
          ...
          <div className="flex-1 overflow-y-auto space-y-3 pr-2 custom-scrollbar">
            {shipments.slice(0, 5).map(ship => (
              <div key={ship._id} className="p-3 rounded-xl bg-blue-50/50 dark:bg-gray-800/30 border border-blue-100/80 dark:border-gray-700/50 hover:bg-blue-50 dark:hover:bg-gray-800/50 transition-all duration-200 shadow-sm hover:shadow-md">
